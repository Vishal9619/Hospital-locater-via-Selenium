...
all_hospital = pd.read_excel("C:\\Users\\axafrance\\Desktop\\hospitals.xlsx")
full_details = all_hospital.iloc[0:len(all_hospital),[1,2]]  #len(all_hospital)

wb = Workbook()  # making our new workbook
sheet1 = wb.add_sheet('Google coordinates')
sheet2 = wb.add_sheet('No coordinates')
# enter your api key here
api_key = 'AIzaSyCNToPLZPsm7MNWQCN4kFKuJrfV3rX6I5s'  #Key generated by Google
...
for index, row in full_details.iterrows():
	...
	if(x['status']=="OK"):
		...
		sheet2_index_row+=1
	print(str(index)+" "+x['status'])
	if(index%100==0):
		wb.save('Goa_GeoLocations.xlsx')
